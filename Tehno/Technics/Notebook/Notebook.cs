...
/// <summary>
///В данной дерективе реализуется декоратор в виде абстрактного класса семейства ноутбуков. В нем реализуется связь с базовым классом через наследование и отношением ассоциации, а в производных от него классах
